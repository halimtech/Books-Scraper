...
def print_best_books():
    ...
    best_books = sorted(bookse, key=lambda x: x.rating * -1)[:7]
...
def print_cheapest_books():
    ...
    cheapest_books = sorted(bookse, key=lambda x: x.price)[:7]
    for book in cheapest_books:
        print(book)


books_generator = (x for x in bookse)
